...
output=$(../../build/Sort --random 8 -delta 0.001 --permutation) 
# Mem: 2.17 GB
...
output=$(../../build/Sort --random 16 -delta 0.001 --permutation) 
# Mem: 2.53 GB
...
output=$(../../build/Sort --random 32 -delta 0.001 --permutation)  
# Mem: 2.75 GB
...
output=$(../../build/Sort --random 64 -delta 0.001 --permutation)  
# Mem: 2.95 GB
...
output=$(../../build/Sort --random 128 -delta 0.001 --permutation)  
